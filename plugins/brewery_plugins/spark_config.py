...
class SparkConfig:
    ...
    def create_spark_session(self) -> SparkSession:
        """
        Creates and returns a SparkSession configured using parameters from a
        JSON configuration file.

        The method reads Spark configuration options from
        '/opt/airflow/config/airflow_config.json',
        applies them to the SparkSession builder, and initializes the session
